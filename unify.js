...
console.error('baseReStr:', baseReStr);
...
export default function unify(input, options = {}) {
    ...
    console.error("phase 1:", {input, text, options});
    ...
    console.error("phase 0:", {input, text, options});
    ...
    if (options.reducePaths) {
	    ...
	    console.error("phase 2:", {input, text, options});
    }
    ...
    console.error("phase 4:", {input, text, options});
